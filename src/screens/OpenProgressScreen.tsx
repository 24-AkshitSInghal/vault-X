...
const OpenProgressScreen: React.FC<Props> = ({isDark, containerNum, sealNum, onLogout}) => {
    ...
    <SafeAreaView style={[s.safe, {backgroundColor: C.bg}]} edges={['top', 'bottom']}>
      ...
      <View style={s.topBar}>
        ...
        <View style={s.logoWrapper}>
          ...
          />
          {/* <MaterialIcon name="lock" size={45} color={isDark ? '#FFF' : '#000'} style={{marginLeft: 10}} /> */}
        </View>
        <TouchableOpacity
          style={[s.iconBtn]}
      ...
      <View style={s.content}>
        ...
        {/* Data Card */}
        <View style={[s.dataCard, {backgroundColor: '#262626', borderColor: 'rgba(255,255,255,0.05)'}]}>
      ...
      <View style={s.footer}>
        <TouchableOpacity style={[s.logoutBtn, {backgroundColor: '#222'}]} onPress={onLogout} activeOpacity={0.85}>
          <Text style={[s.logoutBtnText, {color: '#FFF'}]}>LOGOUT</Text>
        </TouchableOpacity>
      </View>
